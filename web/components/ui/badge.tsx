...
const badgeVariants = cva(
  'inline-flex items-center justify-center rounded-lg border-2 px-2.5 py-0.5 text-footnote font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-blurple focus:ring-offset-2',
  {
    variants: {
      variant: {
